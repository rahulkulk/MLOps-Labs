# -*- coding: utf-8 -*-
"""Rahul_LLMDataPipeline_Lab4.ipynb
...
# You can also check the submission using the above Google Colab Notebook link.

# RUNNING THE SCRIPT

# 1. Create virtual env: python3 -m venv venv
# 2. Activate virtual env: source venv/bin/activate
# 3. Install dependencies: pip install torch transformers datasets evaluate tqdm
# 4. Run Script: python Rahul_LLMDataPipeline_Lab4.py
